...
// Also filters are mapped to a functional style
for {
  x <- list1
  if x == 1
  y <- list2
...
// The implicit method (later!) converts the Int 1 and its parameter
...
// Precompiled Scala for comprehension without syntactic sugar
/*
